...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    skills: ['Next.js', 'React', 'Redux', 'Prime React', 'AWS S3', 'OAuth', 'JWT'],
    description:
  ...
  },
  {
    ...
    skills: ['React', 'React Native', 'Node.js', 'FFmpeg', 'WebRTC', 'AWS S3', 'AWS Lambda', 'Facebook API', 'YouTube API'],
    description:
  ...
  },
  {
    ...
    skills: ['Node.js', 'TypeScript', 'MongoDB', 'Zod', 'Azure Key Vault', 'Express.js', 'Vitest'],
    description:
