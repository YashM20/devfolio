...
description: "A cross-platform React Native POS application built with Expo SDK, Redux Persist, and an on-device PDF receipt printer."
role: "Frontend Developer (React Native)"
duration: "May 2022 - May 2023"
industry: "Retail / Point of Sale (POS)"
client: "PIPLI TECHNOLOGIES PRIVATE LIMITED"
skills: ["React Native", "Expo SDK", "Redux", "AsyncStorage", "React Navigation", "Vitest"]
...
- **Device registration & OTP-based authentication** with GPS location gating.
- **Category-based product browsing** with image thumbnails and 2-column grids.
...
- Developed the `CheckoutScreen` supporting 5 simultaneous payment methods with real-time split-payment calculations, cheque date validation with regex formatting, wallet OTP verification, and balance inquiry.
...
- Built heavily atomized components (AlertBox, LoginButton, PrincipalButton, MenuImage) used across all 15+ screens.
