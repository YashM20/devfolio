...
<ProjectSlider
  aspect="portrait"
  images="/images/project/livcast/screen-0.webp, /images/project/livcast/screen-1.webp, /images/project/livcast/screen-2.webp, /images/project/livcast/screen-3.webp"
/>
...
_YouTube and Facebook enforce different audio/video encoding guidelines (e.g., specific GOP size, constant frame rates, and AAC audio profiles)._
...
_Uploading files larger than 1GB regularly timed out on unstable mobile network connections._
...
<div className="flex items-center gap-4 my-6 not-prose">
  <img
    src="/images/project/livcast/livcast_logo.webp"
    alt="LivCast Logo"
    className="w-16 h-16 rounded-xl border object-cover bg-muted/30 p-1"
  />
  <div>
    <h3 className="text-xl font-semibold text-foreground">LivCast</h3>
    <p className="text-muted-foreground text-sm font-mono">
      Mobile Live Streaming Application
    </p>
  </div>
</div>
