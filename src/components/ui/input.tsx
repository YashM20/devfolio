 ...
 *
 * Combines built-in and user-provided CSS classes for consistent appearance, accessibility, and state handling. Additional props are forwarded to the underlying input element.
 *
