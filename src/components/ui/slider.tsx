...
function Slider({
  ...
  return (
    <SliderPrimitive.Root
      ...
      max={max}
      className={cn(
        "relative flex w-full touch-none select-none items-center data-[orientation=horizontal]:h-5 data-[orientation=vertical]:h-full data-[orientation=vertical]:w-5 data-[disabled]:opacity-50",
        className
      )}
      {...props}
    >
